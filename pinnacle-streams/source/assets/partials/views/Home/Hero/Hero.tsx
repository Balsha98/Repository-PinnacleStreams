		...
		<div className="div-home-view-hero-container">
			...
			<div className="div-home-view-hero-content-container">
				<div className="div-home-view-hero-content-info-container">
					...
					<p>
						A multi-generational family of ranchers fight to maintain control of their vast land against those encroaching upon it, including land
						developers and a neighboring Native American reservation.
					</p>
				</div>
