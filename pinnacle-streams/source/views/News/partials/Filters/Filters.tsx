...
const Filters = function (): ReactElement {
    return (
        <div className="div-main-edge-container">
            <div className="div-news-view-filters-container">
                <div className="div-news-view-filters-search-container">
                    <Search size={16} />
                    <input id="search" type="text" name="search" placeholder="Search streams..." />
                </div>
                <div className="div-news-view-filters-params-lists-container">
                    <div className="div-news-view-filters-params-list-container">
                        <span>Category:</span>
